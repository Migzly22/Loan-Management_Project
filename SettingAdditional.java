...
public class SettingAdditional implements RootValue {
    ...
    public void ChangeAdminname() {
        ...
        Border cbtn1Bordersett = new MatteBorder(3, 3, 3, 3, Color.decode("#DBDCDE"));// ffffff or DBDCDE oe 8CC7FC or
                                                                                      // ecf6fe //TLBR
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (newAdminName.length() > 0) {
                    try {
                        ...
                        JFrame frame = messages("Success", "\\Check-65.png", "Updated Successfully");
    ...
    public void ChangeUsername() {
        ...
        Border cbtn2Bordersett = new MatteBorder(3, 3, 3, 3, Color.decode("#DBDCDE"));// ffffff or DBDCDE oe 8CC7FC or
                                                                                      // ecf6fe //TLBR
    ...
    public void ChangePassword() {
        ...
        Border cbtn3Bordersett = new MatteBorder(3, 3, 3, 3, Color.decode("#DBDCDE"));// ffffff or DBDCDE oe 8CC7FC or
                                                                                      // ecf6fe //TLBR
        ...
        cbtn3SubmitBtn.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (newPassword.length() > 8 && newPassword.equals(confirmPassword)) {
                    ...
                    String passtext = newPassword.length() > 8 ? "" : "Password is too short";
                    passtext = passtext.equals("") ? "Password Doesnt Match" : "Password is too short";
                    JFrame frame = messages("Login", "\\Ekis-65.png", passtext);
                }
